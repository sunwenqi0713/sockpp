 ...
 * @brief A HTTP client.
 */
class SOCKPP_API Http {
 public:
  /**
   * @brief Define a HTTP request.
   */
  class SOCKPP_API Request {
   public:
    /**
   ...
   private:
    ...
    std::map<std::string, std::string> m_fields;  ///< Fields of the header.
  ...
  class SOCKPP_API Response {
   public:
    ...
    enum class Status {
      ...
      PartialContent = 206,  ///< The server has sent a part of the resource.

      // 3xx: redirection.
      MultipleChoices = 300,   ///< The requested page can be accessed from several locations.
      MovedPermanently = 301,  ///< The requested page has permanently moved to a new location.
      MovedTemporarily = 302,  ///< The requested page has temporarily moved to a new location.
      NotModified = 304,       ///< For conditional requests, means the requested page hasn't changed.
      ...
      RangeNotSatisfiable = 416,  ///< The server can't satisfy the partial GET request.
   ...
   * of zero means that the client will use the system default timeout
   ...
   */
  [[nodiscard]] Response sendRequest(const Request& request,
